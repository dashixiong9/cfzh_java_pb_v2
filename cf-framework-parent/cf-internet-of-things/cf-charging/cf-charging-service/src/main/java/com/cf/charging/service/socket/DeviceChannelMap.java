...
public class DeviceChannelMap {
    // 用户保存用户id与通道的Map对象
    private static Map<String, CfChargingClient> userChannelMap;

    static {
        userChannelMap = new HashMap<String, CfChargingClient>();
    }
     ...
     */
    public static void put(String userid, CfChargingClient cfChargingClient) {
     ...
     * @return Netty通道
     */
    public static CfChargingClient get(String friendid) {
        return userChannelMap.get(friendid);
    }

    public static void printf(){
        for ( Map.Entry<String, CfChargingClient> entry: userChannelMap.entrySet()){
