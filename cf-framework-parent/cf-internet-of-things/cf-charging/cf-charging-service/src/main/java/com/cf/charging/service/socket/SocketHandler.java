...
public class SocketHandler extends ByteToMessageDecoder {
    ...
    CfChargingStationBusinessService cfChargingStationBusinessService = SpringUtil.getBean(CfChargingStationBusinessService.class);

    // 当Channel中有新的事件消息会自动调用
    @Autowired
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        try {
            cfChargingStationBusinessService.handleLink(ctx, msg);
        } catch (Exception e) {
            e.printStackTrace();
            throw e;
        }
