...
import com.cf.carpark.service.mqtt.MqttServer;
...
//    private WebSocketDataServiceImpl webSocketDataService;
    ...
    public IServer init(){
        // 创建服务
        MqttServer mqttServer = new MqttServer(InitParamDTO.base(9004, 1, 4, mqttService,new ClientCache()));
//        WebSocketServer wsServer = new WebSocketServer(InitParamDTO.base(9010, 1, 4, webSocketDataService, new ClientCache()));
        // 启动服务
        return mqttServer.run();
