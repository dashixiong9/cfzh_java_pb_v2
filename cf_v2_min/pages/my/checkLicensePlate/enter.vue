<template>
	<view>
		...
		<view class="buttonNo" :style="plateNo?'':'opacity: 0.5;'" v-if="plateNo.length < 7">
			立即查询
		</view>
		<view class="buttonNo" v-else style="background-color: #488CF5;" @click="addCar">
			立即查询
		</view>
		<InputCar @submit="inputCarSubmit" ref='inputCar' @plateNoChange='InputCarChange' @deleteOne='InputCarDelete'>
		</InputCar>
	</view>
</template>
	...
	export default {
		...
		methods: {
			...
			async addCar() {
				...
				// uni.navigateTo({
				// 	url: 'result?plateNo=' + this.plateNo
				// })
			},
		}
	}
