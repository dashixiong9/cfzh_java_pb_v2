<template>
	<view>
		...
		<view class="Refresh u-flex-r u-col-center u-row-center" @click="refresh">
			<image src="../../../../static/image/my/Refresh2x.png" style="width: 32rpx;height: 32rpx;" ></image>
...
<script>
	export default {
		...
		methods: {
			...
			async getQrCode() {
				var res = await this.$u.api.staffCreateCouponQrCode(this.params)
				console.log(res)
				if (res.code == 10002) {
					res.data.image = this.getBase64ImageUrl(res.data.image)
					this.info = res.data
